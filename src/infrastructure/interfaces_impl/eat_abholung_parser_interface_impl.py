...
class eATAbholungParserInterface(BaseParserInterfaceImpl):
    def __init__(self):
        super().__init__()
        self.waiting_time = 2
        self.category_id = 2
    ...
    def get_termins(self) -> dict:
        items = self.driver.find_element(By.XPATH, '//*[@id="button-plus-21"]')
        items.click()
        items = self.driver.find_element(By.XPATH, '//*[@id="WeiterButton"]')
        items.click()
        time.sleep(self.waiting_time)
        count_days = 10

        item = self.driver.find_element(By.XPATH, f'/html/body/main/div[2]/div/div/div[2]/div/div[1]/div')
        item.click()

        item = self.driver.find_element(By.XPATH, f'/html/body/main/div[2]/div/div/div[2]/div/div[2]/div')
        item.click()

        item = self.driver.find_element(By.XPATH, f'/html/body/main/div[2]/div/div/div[2]/div/div[3]/div')
        item.click()

        item = self.driver.find_element(By.XPATH, f'/html/body/main/div[2]/div/div/div[2]/div/div[4]/div')
        item.click()

        item = self.driver.find_element(By.XPATH, f'/html/body/main/div[2]/div/div/div[2]/div/div[5]/div')
        item.click()
